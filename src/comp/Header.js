...
export default function Header({ setIsModalOpen }) {
    ...
    return (
        <header className="text-gray-600 body-font bg-gray-900 py-1">
            <link rel="stylesheet" href="" />
            <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 p-3">
                ...
                <button
                    onClick={open}
                    className="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
                    Let's Connect
